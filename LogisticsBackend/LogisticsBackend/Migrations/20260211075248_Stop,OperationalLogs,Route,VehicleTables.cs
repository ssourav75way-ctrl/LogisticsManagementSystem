...
{
    /// <inheritdoc />
    public partial class StopOperationalLogsRouteVehicleTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RouteNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OperationalLogs_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OperationalLogs_Users_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OperationalLogs_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationalLogs_DriverId",
                table: "OperationalLogs",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_OperationalLogs_RouteId",
                table: "OperationalLogs",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_OperationalLogs_VehicleId",
                table: "OperationalLogs",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteStops_RouteId_StopNumber",
                table: "RouteStops",
                columns: new[] { "RouteId", "StopNumber" },
                unique: true);
        }
